...
class BuyPriceListenerImplTest {
    ...
    void testInitializeStateForBuyPriceListener() {
        buyPriceListener = new BuyPriceListenerImpl(TRADE_SECURITY_DMART, 50.00, 100, executionService,
                false);

        assertThat(buyPriceListener.getTradeSecurity()).isEqualTo(TRADE_SECURITY_DMART);
    ...
    void testBuy_whenThresholdIsMet() {
        ...
        buyPriceListener = new BuyPriceListenerImpl(TRADE_SECURITY_DMART, 50.00, 100, executionService,
                false);
        buyPriceListener.priceUpdate(TRADE_SECURITY_DMART, 25.00);
    ...
    void testShouldNotBuy_whenThresholdIsNotMet() {
        ...
        buyPriceListener = new BuyPriceListenerImpl(TRADE_SECURITY_DMART, 50.00, 100, executionService,
                false);
        buyPriceListener.priceUpdate(TRADE_SECURITY_DMART, 55.00);
    ...
    void testShouldNotBuy_whenSecurityIsDifferent() {
        ...
        buyPriceListener = new BuyPriceListenerImpl(TRADE_SECURITY_HDFC, 50.00, 100, executionService,
                false);
        buyPriceListener.priceUpdate(TRADE_SECURITY_DMART, 55.00);
    ...
    void testGivenSeveralPriceUpdates_whenTradeIsAlreadyExecucted_shouldBuyOnlyOnce() {
        ...
        buyPriceListener = new BuyPriceListenerImpl(TRADE_SECURITY_DMART, 50.00, 100, executionService,
                false);
        buyPriceListener.priceUpdate(TRADE_SECURITY_DMART, 25.00);
        buyPriceListener.priceUpdate(TRADE_SECURITY_DMART, 10.00);
        buyPriceListener.priceUpdate(TRADE_SECURITY_DMART, 35.00);
