...
class SellPriceListenerImplTest {
    ...
    private static final String TRADE_SECURITY_DMART = "DMART";
    private static final String TRADE_SECURITY_HDFC = "HDFC";
    ...
    void testInitializeStateForSellPriceListener() {
        sellPriceListener = new SellPriceListenerImpl(TRADE_SECURITY_DMART, 70.00, 30, executionService,
                false);

        assertThat(sellPriceListener.getTradeSecurity()).isEqualTo(TRADE_SECURITY_DMART);
    ...
    void testsell_whenThresholdIsMet() {
        ...
        sellPriceListener = new SellPriceListenerImpl(TRADE_SECURITY_DMART, 50.00, 30, executionService,
                false);
        sellPriceListener.priceUpdate(TRADE_SECURITY_DMART, 25.00);
        ...
        assertThat(stringArgumentCaptor.getValue()).as("Should be DMART ")
                .isEqualTo(TRADE_SECURITY_DMART);
    ...
    void testShouldNotsell_whenThresholdIsNotMet() {
        ...
        sellPriceListener = new SellPriceListenerImpl(TRADE_SECURITY_DMART, 50.00, 100, executionService,
                false);
        sellPriceListener.priceUpdate(TRADE_SECURITY_DMART, 55.00);
    ...
    void testShouldNotsell_whenSecurityIsDifferent() {
        ...
        sellPriceListener = new SellPriceListenerImpl(TRADE_SECURITY_HDFC, 70.00, 30, executionService,
                false);
        sellPriceListener.priceUpdate(TRADE_SECURITY_DMART, 55.00);
    ...
    void testGivenSeveralPriceUpdates_whenTradeIsAlreadyExecucted_shouldSellOnlyOnce() {
        ...
        sellPriceListener = new SellPriceListenerImpl(TRADE_SECURITY_DMART, 70.00, 30, executionService,
                false);
        sellPriceListener.priceUpdate(TRADE_SECURITY_DMART, 25.00);
        sellPriceListener.priceUpdate(TRADE_SECURITY_DMART, 10.00);
        sellPriceListener.priceUpdate(TRADE_SECURITY_DMART, 35.00);
