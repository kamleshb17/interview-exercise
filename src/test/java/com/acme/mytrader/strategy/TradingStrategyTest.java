...
public class TradingStrategyTest {
    ...
    @BeforeEach
    void setUp() {
        priceSource = new MockPriceSource(TRADE_SECURITY_DMART, 90.0);
    ...
    void buy() throws InterruptedException {
        ...
        tradingStrategy.buy(TRADE_SECURITY_DMART, 100, 10);
        verify(executionService, times(1))
                .buy(securityCaptor.capture(), priceCaptor.capture(), volumeCaptor.capture());
        assertThat(securityCaptor.getValue()).isEqualTo(TRADE_SECURITY_DMART);
    ...
    void buyForInvalidTradeSecurity() throws InterruptedException {
        ...
        tradingStrategy.buy(TRADE_SECURITY_HDFC, 100, 10);
    ...
    void sell() throws InterruptedException {
        ...
        tradingStrategy.sell(TRADE_SECURITY_DMART, 100.0, 10);
        verify(executionService, times(1))
